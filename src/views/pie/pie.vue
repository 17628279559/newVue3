...
<template>
  <div>
    <svg :style="{'display':!proxy.$piesetting.showall && !proxy.$piesetting.showhis ? 'block':'none'}" class="center" width="1250" height="650" ref="svgRef1" style="background-color: rgba(255, 255, 255, 0.15);border-radius: 10px;">
    </svg>
    <svg :style="{'display':proxy.$piesetting.showall && !proxy.$piesetting.showhis ? 'block':'none'}" class="center" width="1250" height="650" ref="svgRef2" style="background-color: rgba(255, 255, 255, 0.15);border-radius: 10px;">
    </svg>
    <svg :style="{'display':!proxy.$piesetting.showall && proxy.$piesetting.showhis ? 'block':'none'}" class="center" width="1250" height="650" ref="svgRef3" style="background-color: rgba(255, 255, 255, 0.15);border-radius: 10px;">
    </svg>
    <svg :style="{'display':proxy.$piesetting.showall && proxy.$piesetting.showhis ? 'block':'none'}" class="center" width="1250" height="650" ref="svgRef4" style="background-color: rgba(255, 255, 255, 0.15);border-radius: 10px;">
    </svg>
  </div>
</template>
