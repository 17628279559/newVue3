      ...
      <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
        ...
        <div class="navbar-collapse">
          ...
          <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <ul class="menu">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <a href="#" @click="change_example(2)">
                        <i class="fa fa-caret-right"></i> 平平无奇普普通通树3
                      </a>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  <a href="#" @click="change_example(3)">
                    <i class="fa fa-tint"></i> 网易云飙升榜实时直方图
                  </a>
                </li>
            ...
            <!-- 左边侧边栏按钮 -->
            <li v-if="component_name === 3" class="settings" id="general-settings">
              ...
              <div v-if="component_name === 3" class="form-group">
                <label class="col-xs-8 control-label">切换随机数据</label>
    ...
    <div id="content" class="col-md-12">
      <div class="main">
        <div class="row">
          ...
          <div>
            <Histogram v-if="component_name === 3"></Histogram>
          </div>
        </div>
